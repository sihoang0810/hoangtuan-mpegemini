  ...
  if (!service) {
    return (
      <div className="pt-32 pb-20 text-center">
        ...
        <Link to="/dich-vu" className="bg-brand-primary text-white px-8 py-3 rounded-xl font-bold">
        ...
        <div className="section-container grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="flex items-center gap-3 text-brand-primary mb-6">
              ...
              <span className="font-bold uppercase tracking-widest">{service.category === 'electrical' ? 'Điện dân dụng' : service.category === 'plumbing' ? 'Nước dân dụng' : service.category === 'camera' ? 'Camera an ninh' : 'Siêu âm rò rỉ'}</span>
            </div>
          ...
          >
            <div className="aspect-[4/3] rounded-[3rem] overflow-hidden shadow-2xl">
              <img 
                src={`https://images.unsplash.com/photo-${service.id.startsWith('e') ? '1621905251189-08b45d6a269e' : service.id.startsWith('p') ? '1585704032938-164741364232' : service.id.startsWith('c') ? '1557597774-9d273605dfa9' : '1504148455328-c39695b8a592'}?auto=format&fit=crop&q=80&w=1200`}
                alt={service.title}
